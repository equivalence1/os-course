 ...
 * In our case we make it maximum 35 in lenght as we need to reserve our OS
 * and also we may need to split up some region into two (before OS, after OS)
 */
} __attribute__((packed));
